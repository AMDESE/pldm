  ...
  public:
        ...
        CommandInterface(type, name, app)
    {
        app->add_option(
            ...
            ->required();
        /*app->add_option("-f, --feature", featureSupport,
    ...
    std::pair<int, std::vector<uint8_t>> createRequestMsg() override
    {
        ...
        auto rc = encode_rde_negotiate_redfish_parameters_req(
            instanceId, concurrencySupport, &featureSupport,
    ...
    void parseResponseMsg(pldm_msg* responsePtr, size_t payloadLength) override
    {
        ...
        auto rc = decode_rde_negotiate_redfish_parameters_resp(
	...
	/*
        std::stringstream dt;
        ordered_json data;
        dt << deviceConcurrencySupport << ":" << deviceCapabilitiesFlags << ":"
           << deviceFeatureSupport << ":" << deviceConfigurationSignature << ":"
           << providerName->string_length_bytes << ":";
